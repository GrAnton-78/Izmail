  ...
  return (
    <ContactsBlockStyle id="contacts">
      <div className="container">
        <div className="info">
          ...
          <h4>
            ...
            <p>
              ...
              продаж, кстати, у нас затаривался Дартаньян!
            </p>
          </h4>
        ...
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ae7e78e6c007c29a1abd346b463ea727975a1ee0f4a37c3af399c3b78a50e215f&amp;source=constructor"
          width="600"
          height="450"
          frameborder="0">
        </iframe>
